...
##write.csv(bart_ratings(), "2023//2024.csv")    
...
write.csv(cbd_torvik_ratings(2024), "2023//2024.csv")  


old <- read.csv("2023//2015_2022_scored.csv.csv")   ## scored with above
new <- read.csv("2023//2023 - 2023.csv.csv", na.strings=c("","NA"))
temp <- rbind(old,new)
use <- na.omit(temp)
...
validate <- read.csv("2023//2024 - 2024.csv.csv")
